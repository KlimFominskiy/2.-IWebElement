...
## Задание №0. Реализовать создание скриншотов в случае падени теста.
Если тест падает по ошибке, требуется после основного блока теста реализовать создание и сохранение скриншота браузера на момент падения теста.
